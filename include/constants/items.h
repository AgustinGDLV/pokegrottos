...
#define ITEM_ICY_SCROLL         SCROLLS_START + 1
#define ITEM_FIERY_SCROLL       SCROLLS_START + 2
#define ITEM_WATERY_SCROLL      SCROLLS_START + 3
#define ITEM_GRASSY_SCROLL      SCROLLS_START + 4
#define ITEM_ELECTRIC_SCROLL    SCROLLS_START + 5

#define SCROLLS_END             ITEM_ELECTRIC_SCROLL + 1

// Trinkets
#define TRINKETS_START              SCROLLS_END

#define ITEM_RELIC_CROWN_TRINKET    TRINKETS_START
...
#define EFFECT_ITEM_FIERY_SCROLL            ITEM_EFFECT_END_EXPANSION + 2
#define EFFECT_ITEM_WATERY_SCROLL           ITEM_EFFECT_END_EXPANSION + 3
#define EFFECT_ITEM_GRASSY_SCROLL           ITEM_EFFECT_END_EXPANSION + 4
#define EFFECT_ITEM_ELECTRIC_SCROLL         ITEM_EFFECT_END_EXPANSION + 5
