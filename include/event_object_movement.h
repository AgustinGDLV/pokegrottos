...
void MovementType_EncounterTrackPlayer(struct Sprite *);
...
u8 MovementType_EncounterTrackPlayer_Search(struct ObjectEvent *, struct Sprite *);
u8 MovementType_EncounterTrackPlayer_WanderMove(struct ObjectEvent *, struct Sprite *);
u8 MovementType_EncounterTrackPlayer_WanderExec(struct ObjectEvent *, struct Sprite *);
u8 MovementType_EncounterTrackPlayer_WanderPause(struct ObjectEvent *, struct Sprite *);
u8 MovementType_EncounterTrackPlayer_TrackEmote(struct ObjectEvent *, struct Sprite *);
u8 MovementType_EncounterTrackPlayer_TrackMove(struct ObjectEvent *, struct Sprite *);
u8 MovementType_EncounterTrackPlayer_TrackExec(struct ObjectEvent *, struct Sprite *);
u8 MovementType_EncounterTrackPlayer_TrackPause(struct ObjectEvent *, struct Sprite *);
