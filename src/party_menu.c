...
static UNUSED void DrawEmptySlot_Equal(u8 windowId)
{
    BlitBitmapToPartyWindow(windowId, sEqualEmptySlotTileNums, 14, 0, 0, 14, 5);
} //
...
const struct OamData sOamData_RankStar =
{
    .bpp = ST_OAM_4BPP,
...
const struct CompressedSpriteSheet sSpriteSheet_RankStar =
{
    gRankStar_Gfx, 384, TAG_RANK_STAR
};

const struct SpritePalette sSpritePalette_RankStar =
{
    gRankStar_Pal, TAG_RANK_STAR
};

const struct SpriteTemplate sSpriteTemplate_RankStar =
{
    .tileTag = TAG_RANK_STAR,
    .paletteTag = TAG_RANK_STAR,
    .oam = &sOamData_RankStar,
...
static void DisplayPartyPokemonLevel(u8 level, struct PartyMenuBox *menuBox)
{
    ...
    // Load graphics.
    LoadSpritePalette(&sSpritePalette_RankStar);
