...
const u8 gText_ICanPayVar1[] = _("I can offer you ¥{STR_VAR_1}.\nIs that acceptable to you?");
...
const u8 gText_TextSpeedFaster[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}FASTER");
...
const u8 gText_MenuPokedex[] = _("DEX");
const u8 gText_MenuPokemon[] = _("PARTY");
