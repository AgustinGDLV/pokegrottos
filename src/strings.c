...
const u8 gText_MainMenuNewRun[] = _("NEW RUN");
...
const u8 gText_WelcomeToKecleonShop[] = _("Welcome to the Kecleon Shop!");
const u8 gText_AnythingElseICanHelp2[] = _("Anything else I can help you with?");
const u8 gText_Var1CostsVar2[] = _("{STR_VAR_1} costs ¥{STR_VAR_2}.\nWant to buy it?");
const u8 gText_IShallPayVar2[] = _("For {STR_VAR_2}, I shall pay ¥{STR_VAR_2}.\nIs that acceptable?");
const u8 gText_ThankYouSoVeryMuch[] = _("Thank you so very much.");
const u8 gText_LookingForwardToServing[] = _("I'm looking forward\nto serving you again.");
...
const u8 gText_ContinueMenuFloor[] = _("FLOOR");
